        ...
        <div className="bg-neutral-1000">
            <main className="flex flex-col px-[0.9375rem] pb-5 items-start gap-3  w-screen h-screen">
                ...
                <div className="flex flex-col gap-10 self-stretch">
                    <div>
                        <h2 className="font-inter text-2xl font-bold text-neutral-50 self-stretch">We sent you a code</h2>
                        <h3 className="text-[0.874rem] font-normal text-neutral-500">
                            Enter it below to verify dnaik051999@gmail.com
                        </h3>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="relative flex py-4 px-3 items-center justify-between gap-2.5 rounded border border-twitter—blue self-stretch">
                            <label htmlFor="inputText" className="text-twitter—blue absolute bg-neutral-1000 px-1 left-[1.21rem] -top-3">Verification
                                code</label>
                            <input type="text" placeholder="Verification code" name="inputText" className="bg-black text-neutral-50 placeholder:text-neutral-500 focus:outline-none w-full font-inter text-lg font-normal" />
                        </div>
                ...
                <div className="flex flex-col pt-20 justify-end items-center gap-2.5 flex-[1_1_0] self-stretch">
                    <a href="./create-account-step-4.html" className="flex self-stretch">
                        <button className="py-3 px-6 bg-neutral-50 flex justify-center items-center grow self-stretch shadow-button backdrop-blur-button rounded-create gap-2.5
